	...
	for mp3dicts in mp3fileslist:
		...
		if mp3dicts is not None:		
			try:
				...
				if mp3dicts['mp3tags']['artist'] and mp3dicts['mp3tags']['song'] is not None:
					print(search(mp3dicts['mp3tags']['artist'],mp3dicts['mp3tags']['song']))
...
if __name__ == '__main__':
	...
	for dictsongtag in dictsongtaglist:
		songpath = str(dictsongtag.keys())
		if dictsongtag is not None:
